...
export default function OwnerJournal() {
  return (
    <section id="journal" className="relative overflow-hidden bg-[#050506] px-5 py-28 md:px-8 md:py-40">
      <div className="relative z-10 mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.58fr_0.42fr] lg:items-center">
        <motion.div
        ...
        >
          ...
          <h2 className="max-w-4xl text-[clamp(4rem,8vw,8.8rem)] font-black leading-[0.86] tracking-tight text-white">
            Built By Someone Who Still Signs Off On The Work
          </h2>
          <blockquote className="mt-10 max-w-3xl text-3xl font-black leading-tight tracking-tight text-white md:text-5xl">
            &ldquo;I didn&apos;t start A&amp;S to clean cars. I started it because vehicles deserve to be protected.&rdquo;
          </blockquote>
          <p className="mt-8 max-w-2xl text-xl leading-relaxed text-white/56">
